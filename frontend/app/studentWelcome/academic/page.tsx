...
const AcademicPage: React.FC = () => {
    return (
        <div className="bg-gradient-to-b from-white to-white dark:from-black dark:to-gray-900">
              <StuNavBar />
          ...
          <AnimatedPinDemo
  title="PersonalizedRoadmaps"
  href="/studentWelcome/academic/roadmap"
  h3="Your AI-Powered Success Path"
  subhead="Smart roadmaps with quizzes, videos, courses, and more—tailored just for you!"
/>
