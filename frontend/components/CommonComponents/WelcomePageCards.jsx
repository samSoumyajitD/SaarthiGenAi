...
export function CardDemo({title,subHead,btn}) {
  return (
    (<Card>
     ...
     {subHead}
      ...
      <Link href="/studentWelcome">
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className="mt-4 px-8 py-2 bg-blue-600 text-white font-semibold rounded-full shadow-md hover:bg-blue-500"
      >
      {btn}
      </motion.button>
      </Link>
